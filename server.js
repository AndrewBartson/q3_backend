...
const states_summary = [
  ...
  { 'id': 11, 'key': 11, 'regionName':'Idaho','code':'ID', 'electoral_votes': 4, 'group': 2, 'margin': 31.77 },
  ...
  { 'id': 26, 'key': 26, 'regionName':'Nebraska','code':'NE', 'electoral_votes': 5, 'group': 2, 'margin': 25.05 },
  ...
  { 'id': 30, 'key': 30, 'regionName':'New Mexico','code':'NM', 'electoral_votes': 5, 'group': 5, 'margin': -8.21 },
  ...
  { 'id': 38, 'key': 38, 'regionName':'Rhode Island','code':'RI', 'electoral_votes': 4, 'group': 6, 'margin': -15.51 },
  ...
  { 'id': 43, 'key': 43, 'regionName':'Utah','code':'UT', 'electoral_votes': 6, 'group': 4, 'margin': 18.08 },
  { 'id': 44, 'key': 44, 'regionName':'Vermont','code':'VT', 'electoral_votes': 3, 'group': 7, 'margin': -26.41 },
  { 'id': 45, 'key': 45, 'regionName':'Virginia','code':'VA', 'electoral_votes': 13, 'group': 5, 'margin': -5.32 },
  { 'id': 46, 'key': 46, 'regionName':'Washington','code':'WA', 'electoral_votes': 12, 'group': 6, 'margin': -15.71 },
